...
<title>iMedical長照醫療網編輯會員頁面</title>
</head>
<body>
	<h1>編輯會員列表</h1>
	...
	<h1 style=" margin-top: 20px; margin-bottom: 30px; font: 50px bold; text-align: center;">編輯會員資料</h1>
	...
	<form:form action="editMember" modelAttribute="someMember"
		...
		<div class="form-group">
			...
			<form:input type="text" path="memberAccount" class="form-control-sm"
				id="account" aria-describedby="accountHelp" required="required" />
		</div>
		...
		<div class="form-group">
			...
			<form:input type="text" path="memberBirthday" class="form-control-sm"
				id="birthday" aria-describedby="birthdayHelp"
				placeholder="ex: 1998/08/08" required="required" />
		</div>
		...
		<div class="form-group">
			...
			<form:input type="text" path="memberGender" class="form-control-sm"
				id="gender" aria-describedby="onboardHelp" placeholder="ex: 男/女"
				required="required" />
		</div>
